...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,700" rel="stylesheet">
    ...
    <style>
    body {
      background: linear-gradient(45deg, #3eaaf7a1, #ffffff) !important;
      height:768px;
    }
...
?>
    ...
    <section class="probootstrap-cover overflow-hidden relative" style=" padding-top:0px; height:768px" >
      <div class="overlay"></div>
      <div class="boxeiei">
        <div class="container" style="padding-right:15em; ">
          <div class="row" style="padding-top:2em;">
            <div class="col-md">
              <h1 class="heading mb-2 display-4 font-light probootstrap-animate" style="color: white;"><b>Request Confirmation</b></h1>
            </div>
          </div>
            <div class="row align-items-center" style="padding:0; padding-right:10em; padding-left:-10em;">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row">
                      <div class="col-md-3 ml-auto mr-auto" >
                        <br><center><button type="submit" style="width:235px; height:49px; margin-left: -50px;" class="btn btn-primary btn-block">CONFIRM</button></center>
                      </div>
                    </div>
                </div>
              </form>
