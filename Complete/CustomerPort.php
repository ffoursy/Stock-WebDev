...
<section class="probootstrap-cover overflow-hidden relative" style="color:white; margin-top:0px;">
    ...
    <div class="probootstrap-animate">
      <div class="boxeiei">
        <div class="limiter">
              ...
              <div class="row">
                <h2 style="font-size:30px; text-align:center; color: white; font-family:Work Sans;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Customer's Port</h2>
              </div>
              <br>
				      <div class="table100">
					    <table>
                <?php
                  ...
                  //$output .= $broker_name;
                  //echo $account_num;
                  $getport = mysqli_query($con,"SELECT user_account_id, account_number, bank_account_number, pincode, total_port_balance
                  FROM user_account_data WHERE username = '$username';");
                  $i = 0;
                  echo '<table style="width:60%;">
                  <thead>
                    <tr class="table100-head">
                      <th class="column1">Account No.</th>
                      <th class="column2">Bank Account</th>
                      <th class="column3">Pincode</th>
                      <th class="column4">Total Port Balance</th>
                      <th class="column5">Details</th>
                    </tr>
                  </thead>';
                  echo "<tbody>";
                  while ($result = mysqli_fetch_array($getport))
                    {
                      echo '<tr>
                            <td class="column1">'.$result['account_number'].'</td>
                            <td class="column2">'.$result['bank_account_number'].'</td>
                            <td class="column3">'.$result['pincode'].'</td>
                            <td class="column4">'.$result['total_port_balance'].'</td>
                            <td class="column5"><a href="CustomerPortDetail.php?account='.$result['user_account_id'].'" role="button"><img src="https://image.flaticon.com/icons/svg/122/122648.svg" height="25" width="25"></a></td>';
                    $i += 1;
                  }
                  echo "</tbody>";
                  $_SESSION['numcus'] = $i;
              ...
              <br><center><p style="color:white; font-family:Work Sans;">Total <?php echo $_SESSION['numcus']?> account(s) for this customer.<br><br></p></center>
				      </div>
			      </div>
		      </div>
        </div>
