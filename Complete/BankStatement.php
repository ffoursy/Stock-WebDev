          ...
          <div class="dropdown2-container">
            <?php
              ...
              $result = mysqli_query($con,"SELECT ud.account_number
                      FROM personal_data p JOIN user_account_data ud ON p.username=ud.username
                      WHERE ud.username='$Username'") or die("Error: ".mysqli_error($con));
              echo '<button type="submit" class="btn-submenu4" style="background-color: #262626; cursor:pointer; text-align:left;" id="value5days" value="5days">5-Day Total Trading Value</button>';
            ?>
          </div>
              ...
              <div class="container-table100">
                  <div class="wrap-table100">
                    <div class="row">
                      ...
                      <h2 id="titleAJAX" style="font-size:30px;"><b></b></h2>
                    </div>
                    <br>
