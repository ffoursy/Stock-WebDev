        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <?php
              ...
              $sql = mysqli_query($con,"SELECT broker_name FROM broker_list WHERE broker_symbol = '$Username';");
              $result = mysqli_fetch_array($sql);
              $_SESSION['brokerName'] = $result['broker_name'];
              ?>
              <h2 class="heading mb-2 display-4 font-light probootstrap-animate">Welcome <br><a style="color:green"><?php echo $_SESSION['brokerName']?></a><br>to Super Rich</h2>
