            ...
            <div class="limiter">
              <div class="container-table100">
                <div class="wrap-table100">
                  <div class="row">
                    <div class="col-md-6">
                      <h2 style="font-size:30px;"><b>Personal Data</b></h2>
                    </div>
                  </div>
                  <div class="row">
                    <div class="ml-auto">
                ...
                <form id="addPersonal_form" method="post">
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <label for="Surname" class="col-sm-6 col-form-label"><b>Surname: </b></label>
                      ...
                      <span class="col-sm-10 col-form-label" id="add_submit_message" style="color:red;"></span>
                    </div>
                  </div>
                </div>
